...
{
    public partial class VirtualController2 : UserControl
    {
        ...
        /// 移动速度等级
        /// </summary>
        public double SpeedLevel { get { return Math.Round(((double)R_Cur / (double)LCC.Radius), 2, MidpointRounding.AwayFromZero); } }

        public delegate void PressedDelegate();
        public event PressedDelegate FG_Pressed;
        public event PressedDelegate FG_Lift;

        public VirtualController2()
        {
            InitializeComponent();
        ...
        {
            this.Paint += VirtualController_Paint;
        ...
        /// 绘制
        /// </summary>
        private void PaintChessboard(PaintEventArgs e)
        {
